defmodule Pamela.UserTest do
  ...
  describe "telegram_users" do
    ...
    @valid_attrs %{first_name: "some first_name", id: 42, last_name: "some last_name", username: "some username"}
    @update_attrs %{first_name: "some updated first_name", id: 43, last_name: "some updated last_name", username: "some updated username"}
    ...
    test "update_telegram_user/2 with invalid data returns error changeset" do
      telegram_user = telegram_user_fixture()
      assert {:error, %Ecto.Changeset{}} = User.update_telegram_user(telegram_user, @invalid_attrs)
    ...
    test "delete_telegram_user/1 deletes the telegram_user" do
      ...
      assert_raise Ecto.NoResultsError, fn -> User.get_telegram_user!(telegram_user.id) end
    end
